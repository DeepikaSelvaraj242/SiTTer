  ...
  <% 
	...
	try
	{
 	  	...
 	  	if(rs.next())
    	{
    		...
    		System.out.println("Displaying edit for user : "+mail);
    	}
	}
	catch(Throwable e)
	{
                  ...
                  <form class="contact-us pattern-bg" method="POST" action="U_registercon">
					  <div class="col-sm-12">
						...
						<div class="form-group">
						  ...
						  <input type="text" name="childname" id="name" class="form-control" value=<%out.println(childname);%> required>
						  <span id="namelocation" style="color:red"></span>
						 </div>
                        </div>
                       ...
                       <div class="col-sm-12">
					    <div class="form-group">
						 ...
						 <input type="email" name="email" id="email" class="form-control" value=<%out.println(mail);%> disabled required>
                    	...
                    	<div class="col-sm-15">
						  ...
						  <div class="form-group">
							...
							<input type="date" name="dob" id="dob" class="form-control" value=<%out.println(dob);%> min="2010-01-01" max="2019-12-31" required>
						   </div> 
                          </div>
						  ...
						  <div class="form-group">
							...
							<input type="number" name="age" id="age" class="form-control" value=<%out.println(age);%> min=1 max=10 required>
						   </div>
                          </div>
                          </div>
						  ...
						  <div class="form-group">
							...
							<option value=<%out.println(relation);%> selected><%out.println(relation);%></option>
						  ...
						  <div class="form-group">
							...
							<option value=<%out.println(gender);%> selected><%out.println(gender);%></option>
							<option>Male</option>
						  ...
						  <select name="city" name="city" id="city" class="form-group form-control"  required>
							<option value=<%out.println(city);%> selected><%out.println(city);%></option>
                        ...
                        <div class="form-group">
						  <label>MOBILE</label>
						  <input type="mobile" name="mobile" id="mobile" class="form-control" value=<%out.println(mobile);%> required>
                       ...
                       <div class="col-sm-6">
					    ...
					    <div class="textarea-message form-group">
						  <label>ADDRESS</label>
					      <textarea id="address" name="address" class="textarea-message form-control" rows="5" required><%out.println(address);%></textarea>
						  </div>
                         </div>
                    <div class="text-center">      
		               <button type="submit" class="button button-style button-style-dark button-style-color-2" onclick="return AlertVariable();">Save</button>
	                  </div>
