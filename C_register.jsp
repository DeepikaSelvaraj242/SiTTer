         ...
         <div class="margin-top-30 margin-bottom-50">
           <div class="row">
             ...
             <div class="col-md-offset-3 col-sm-offset-2 col-md-6 col-sm-8">   
               ...
               <div class="row">
                  <form class="contact-us pattern-bg" method="POST" action="C_registercon">
                    <div class="col-sm-24">
					  <div class="col-sm-12">
                       ...
                       <div class="col-sm-12">
                    	...
                    	<div class="col-sm-15">
						  ...
						  <div class="form-group">
							...
							<input type="date" name="dob" id="dob" class="form-control" placeholder="Your Date of birth" max="2003-12-31" required>
						   </div>
                          </div>
                        ...
                        <div class="col-sm-6">
						  <label>CITY</label>
						  <select name="city" id="city" class="form-group form-control" required>
                       ...
                       <div class="col-sm-6">
                        <div class="form-group">
						  ...
						  <input type="time" name="fromtime" id="fromtime" class="form-control" placeholder="From time" required>
						 </div>
                        </div>
                       ...
                       <div class="col-sm-6">
                        <div class="form-group">
						  ...
						  <input type="time" name="totime" id="totime" class="form-control" placeholder="To time" required>
						 </div>
                        </div>
                        </div>
